...
<input type="text" class="form__input" autofocus placeholder="Username or email" name="email" required>
...
<p class="form__text">
<a class="form__link" href="registration.jsp" id="linkCreateAccount">Don't have an account? Create account</a>
</p>
